...
cmd_opt.add_argument('-RL_param_1',  type=float, help = 'regularizer parameter')
cmd_opt.add_argument('-RL_param_2', type=float)
cmd_opt.add_argument('-regressor_saved_dir', default='', help='pretrained regressor dir')
cmd_opt.add_argument('-vanilla_vae_save_dir', default='', help='pretrained vanilla supervised vae dir')
cmd_opt.add_argument('-training_data_dir', default='../data/data_278', help='training data directory')
